...
router.route('/').post(authMiddleware_1.protect, orderController_1.createOrder).get(authMiddleware_1.protect, authMiddleware_1.admin, orderController_1.getOrders);
